<template>
  <aside class="left-sidebar">
    <section>
      <Card classes="grey-card intro-card">
        <h2>
          <a href="">DEV Community</a> is a community of 815,327 amazing
          developers
        </h2>
        <p>
        ...
        <div class="btn btn-blue create-btn">Create account</div>
      ...
      <ul class="social-links">
        <li>
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="arshz8mnwvuvey8jtz5uxpfmtpzkfoc0"
            class="crayons-icon c-link__icon"
          >
            <title id="arshz8mnwvuvey8jtz5uxpfmtpzkfoc0">Twitter</title>
            <path
        ...
        <li>
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="ao4ubacnsv9l7ir8uo7gz1fugctvw1q0"
            class="crayons-icon c-link__icon"
          >
            <title id="ao4ubacnsv9l7ir8uo7gz1fugctvw1q0">Facebook</title>
            <path
        ...
        <li>
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="ael6hct7nn68jutlg22ketbxpdz8vnvy"
            class="crayons-icon c-link__icon"
          >
            <title id="ael6hct7nn68jutlg22ketbxpdz8vnvy">Github</title>
            <path
        ...
        <li>
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="aoa1fi6m300lhyukbtt8idkk2rysc2pd"
            class="crayons-icon c-link__icon"
          >
            <title id="aoa1fi6m300lhyukbtt8idkk2rysc2pd">Instagram</title>
            <path
        ...
        <li>
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="aidjarkruzhqadnmmit0meqj8c2jdu09"
            class="crayons-icon c-link__icon"
          >
            <title id="aidjarkruzhqadnmmit0meqj8c2jdu09">Twitch</title>
            <path
    ...
    <section v-if="!mobile">
      <Card classes="grey-card thanks-card">
        <h3>
          Nearly 700 develoers have contributed to the Forem codebas that powers
          DEV and other communities.
        </h3>
        <strong>Thank you!</strong>
        <a href="">Forem on Github</a>
      </Card>
      <Card classes="grey-card shop-card">
        ...
        <small><a href="">>> Shop Forem, DEV and CodeNewbie merch</a></small>
      </Card>
    </section>
  </aside>
</template>
